...
using AnThanhLam.Data;
using AnThanhLam.Model.Models;
using AnThanhLam.Service;
using AnThanhLam.Web.Infrastructure.Core;

[assembly: OwinStartup(typeof(AnThanhLam.Web.App_Start.Startup))]

namespace AnThanhLam.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(AnThanhLamDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<AnThanhLamDbContext>());
